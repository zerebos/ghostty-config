<script lang="ts">
    ...
    const {
        ...
        onclose,
        onimport,
        keyFormatter = (key: string) => key // TODO: the modal should probably just receive the already formatted keys instead of having to do this lookup itself, but this is easier for now
    }: Props = $props();
</script>
...
<DialogModal title="Shared Config" {onclose}>
    ...
    <div class="share-preview">
        {#if parsedConfig}
            ...
            <div class="row">&nbsp;</div>
            {#each Object.entries(parsedConfig) as [id, value], i (i)}
