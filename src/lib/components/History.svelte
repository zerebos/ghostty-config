...
<div class="history">
    <button class="back" type="button" onclick={back} disabled={!canGoBack()} title={msg("Go Back", "后退")}>
    ...
    <button class="forward" type="button" onclick={forward} disabled={!canGoForward()} title={msg("Go Forward", "前进")}>
