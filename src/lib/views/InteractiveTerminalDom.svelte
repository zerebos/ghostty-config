<script lang="ts">
    import type {Command, ExecContext, Line, Segment, ExecResult, HistoryEntry, PromptSnapshot, DirNode, FSNode} from "$lib/terminal";
    import {cwdAbs, cwdString, getNode, makeFilesystem, resolveParts} from "$lib/terminal/filesystem";
