...
<Group title="" note={"Use this page to test your locally installed fonts as they may look in the terminal along with colors and glyphs.\n\nNote: this playground does not set any actual settings."}>
    <PreviewFrame maxHeight="180px">
        <!-- Local test font overrides the surface's --config-font-* so this playground can preview an arbitrary installed font without touching the config. -->
        <div style="font-family: {fontFamily}; font-size: {fontSize}px; font-style: {italic === "true" ? "italic" : "normal"}; font-weight: {bold === "true" ? 700 : 400};">
