        ...
        groups: [
            {
                ...
                name: "",
                settings: [
                    {id: "language", name: "UI language", note: "Set Ghostty's GTK GUI language (e.g. `de`, `fr`). Requires a full restart. GTK only.", type: "text", value: ""},
            ...
            },
            {
                ...
                settings: [
                    {id: "notifyOnCommandFinish", name: "Notify on command finish", note: "Requires shell integration or OSC 133 escape sequences. GTK only.", type: "dropdown", value: "never", options: ["never", "unfocused", "always"]},
                    {id: "notifyOnCommandFinishAction", name: "Notification action", note: "How the user is notified. Comma-separated list. Available: bell, notify. Prefix with `no-` to disable. GTK only.", type: "text", value: "bell"},
                    {id: "notifyOnCommandFinishAfter", name: "Minimum runtime before notifying", note: "How long a command must run before a notification is sent. Format like `5s`, `500ms`. GTK only.", type: "text", value: "5s"},
                ]
            }
        ]
    },
